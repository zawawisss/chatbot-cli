...
export class FileSystemTools {
    ...
    static async writeFile(path, content, createDirectories = true) {
        try {
    ...
    static async listFiles(path = '.', pattern = '*', includeHidden = false, recursive = false) {
        try {
    ...
    static async createDirectory(path, recursive = true) {
        try {
    ...
    static async searchFiles(pattern, path = '.', filePattern = '*', caseSensitive = false) {
        try {
    ...
    static async getFilesRecursive(path, pattern, includeHidden, recursive) {
        const files = [];
        try {
