...
export class PromptEnhancer {
  private baseSystemPrompt = "You are a helpful AI assistant with deep understanding of human psychology and communication patterns.";
  ...
  private buildEnhancedSystemPrompt(intent: HumanIntent, context: ConversationContext): string {
  ...
  private generateToneAdjustments(intent: HumanIntent, context: ConversationContext): string[] {
  ...
  private determineResponseStrategy(intent: HumanIntent, context: ConversationContext): string {
    let strategy = "";
